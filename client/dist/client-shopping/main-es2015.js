...
let AddProductComponent = class AddProductComponent {
    constructor(productsService, categoriesService, redux) {
...
let AdminPageComponent = class AdminPageComponent {
    constructor(categoriesService, productsService, adminService, router, redux) {
        this.categoriesService = categoriesService;
        this.productsService = productsService;
    ...
    getAdmin() {
        this.adminService.getAdmin()
            .subscribe(admin => {
            const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_8__["ActionType"].GetAdmin, payload: admin };
    ...
    logout() {
        ...
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_8__["ActionType"].LogOut, payload: undefined };
        this.redux.dispatch(action);
...
let CartComponent = class CartComponent {
    constructor(redux, cartsItemsService, router) {
        this.redux = redux;
    ...
    order() {
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_5__["ActionType"].SaveTotalAmount, payload: this.totalAmount };
        this.redux.dispatch(action);
...
let HomeComponent = class HomeComponent {
    constructor(redux, cartsService, productsService, ordersService, customersService, cartsItemsService, router) {
        this.redux = redux;
    ...
    getCarts(customer) {
        this.cartsService.getAllCartsByCutomerID(customer._id)
            .subscribe(carts => {
            const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].GetAllCarts, payload: carts };
            this.redux.dispatch(action);
    ...
    getTotalAmount() {
        ...
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].SaveTotalAmount, payload: total };
        this.redux.dispatch(action);
    }
    // Logout:
    logout() {
        sessionStorage.clear();
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].LogOut, payload: undefined };
        this.redux.dispatch(action);
        this.loggedIn = false;
        this.router.navigate(["/home"]);
    }
    // Only if customer is not new get latest order:
    getTheLatestOrder(_id) {
    ...
    getOneCart(carts) {
        for (let cart of carts) {
            if (cart.open === true) {
                const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].GetOneCart, payload: cart };
                this.redux.dispatch(action);
...
let LoginComponent = class LoginComponent {
    constructor(loginService, ordersService, router, cartsService, cartsItemsService, redux) {
        ...
        if (this.login.isAdmin === true) {
            this.loginService.loginAdmin(this.login)
                ...
                if (response === false) {
                    ...
                    const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].GetAdmin, payload: response.admin };
                    this.redux.dispatch(action);
        ...
        // if Admin checkbox is not checked - cheack customer's login details: 
            ...
            this.loginService.loginCustomer(this.login)
                ...
                if (response === false) {
                    ...
                    const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].GetOneCustomer, payload: response.customer };
                    this.redux.dispatch(action);
                    const action2 = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].GetLatestOrder, payload: null };
...
let OrderPageComponent = class OrderPageComponent {
    constructor(modalService, redux, cartsItemsService, citiesService, customersService, activatedRoute, ordersService, cartsService, router) {
    ...
    makeOrder() {
        ...
        this.ordersService.addOrder(this.order)
            ...
            const modalRef = this.modalService.open(_popup_order_confirmation_popup_order_confirmation_component__WEBPACK_IMPORTED_MODULE_10__["PopupOrderConfirmationComponent"], this.modalOptions);
    ...
    logout() {
        sessionStorage.clear();
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_12__["ActionType"].LogOut, payload: undefined };
        this.redux.dispatch(action);
        this.router.navigate(["/home"]);
    }
};
...
let Page404Component = class Page404Component {
    ...
    goHome() {
        sessionStorage.clear();
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].LogOut, payload: undefined };
        this.redux.dispatch(action);
        this.router.navigate(["/home"]);
    }
};
...
let PopupOrderConfirmationComponent = class PopupOrderConfirmationComponent {
    constructor(activeModal, router, redux) {
    ...
    goHome() {
        ...
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_5__["ActionType"].GetOneCart, payload: null };
        this.redux.dispatch(action);
        const action2 = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_5__["ActionType"].GetLatestOrder, payload: this.order };
        this.redux.dispatch(action2);
        const action3 = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_5__["ActionType"].GetAllProducts, payload: [] };
    ...
    closePopup() {
        this.activeModal.close();
        sessionStorage.clear();
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_5__["ActionType"].LogOut, payload: undefined };
        this.redux.dispatch(action);
        this.router.navigate(["/home"]);
    }
};
PopupOrderConfirmationComponent.ctorParameters = () => [
...
let PopupsProductsComponent = class PopupsProductsComponent {
    constructor(activeModal, cartsItemsService) {
        this.activeModal = activeModal;
        this.cartsItemsService = cartsItemsService;
...
PopupsProductsComponent.ctorParameters = () => [
...
let RegisterComponent = class RegisterComponent {
    constructor(citiesService, registerService, router, redux) {
        this.citiesService = citiesService;
    ...
    addCustomer() {
        ...
        this.registerService.registerCustomer(this.customer)
            ...
            if (response !== false) {
                ...
                const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].GetOneCustomer, payload: this.customer };
                this.redux.dispatch(action);
                const action2 = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_9__["ActionType"].GetLatestOrder, payload: null };
                this.redux.dispatch(action2);
                // jwt - JSON Web Token:
...
let SearchProductsComponent = class SearchProductsComponent {
    constructor(productsService, redux, router) {
        this.productsService = productsService;
        this.redux = redux;
        this.router = router;
    ...
    searchProductsBySearchWord() {
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].GetAllProducts, payload: [] };
        this.redux.dispatch(action);
        this.productsService.getAllProductsBySearchWord(this.search)
            ...
            if (products.length === 0) {
                ...
                const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].GetAllProducts, payload: products };
                this.redux.dispatch(action);
                this.noSearchResult = false;
                this.buttonDisabled = false;
                this.sendNoSearchResultEvent();
...
let ShoppingPageComponent = class ShoppingPageComponent {
    constructor(modalService, categoriesService, productsService, customersService, cartsItemsService, cartsService, router, activatedRoute, redux) {
        this.modalService = modalService;
        this.categoriesService = categoriesService;
        this.productsService = productsService;
        this.customersService = customersService;
        ...
        if (this.isCustomerLoggedIn()) {
            ...
            if (this.carts === null || this.carts === undefined || this.cartsItems.length === 0) {
                this.cartsService.getAllCartsByCutomerID(userID)
                    .subscribe(carts => {
                    const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_7__["ActionType"].GetAllCarts, payload: carts };
                    this.redux.dispatch(action);
                    this.getOneCart(carts);
                }, err => {
                    // if token expired on the server side
    ...
    logout() {
        sessionStorage.clear();
        const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_7__["ActionType"].LogOut, payload: undefined };
        this.redux.dispatch(action);
        this.router.navigate(["/home"]);
    }
    // Check if customer is logged in:
    ...
    getOneCart(carts) {
        for (let cart of carts) {
            if (cart.open === true) {
                const action = { type: src_app_redux_actionType__WEBPACK_IMPORTED_MODULE_7__["ActionType"].GetOneCart, payload: cart };
                this.redux.dispatch(action);
                this.getAllCartsItemsByCartId(cart._id);
            }
        }
    ...
    selectProduct(prod) {
        const modalRef = this.modalService.open(_popups_products_popups_products_component__WEBPACK_IMPORTED_MODULE_10__["PopupsProductsComponent"]);
...
ShoppingPageComponent.ctorParameters = () => [
...
let SiteMenuComponent = class SiteMenuComponent {
    constructor(router, redux) {
        this.router = router;
        this.redux = redux;
    }
...
SiteMenuComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: ng2_redux__WEBPACK_IMPORTED_MODULE_3__["NgRedux"] }
];
...
class Cart {
    constructor(_id, customer, date, open) {
        this._id = _id;
...
class CartItem {
    constructor(_id, product, quantity, price, cart) {
        this._id = _id;
...
class Customer {
    constructor(_id, firstName, lastName, email, password, confirmPassword, phone, city, street, houseNumber, newCustomer) {
        this._id = _id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
...
class Order {
    constructor(_id, customer, cart, price, city, street, houseNumber, deliveryDate, orderDate, cc) {
        this._id = _id;
        this.customer = customer;
        this.cart = cart;
        this.price = price;
...
class Product {
    constructor(_id, productName, category, price, image) {
        this._id = _id;
...
let CartsItemsService = class CartsItemsService {
    constructor(httpClient, redux, router) {
        this.httpClient = httpClient;
        this.redux = redux;
        this.router = router;
    }
    ...
    logout() {
        sessionStorage.clear();
        const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].LogOut, payload: undefined };
        this.redux.dispatch(action);
        this.router.navigate(["/home"]);
    }
    ...
    addProductToCart(cartItem) {
        this.httpClient.post("http://localhost:3001/api/carts-items", cartItem, this.getHeaders())
            ...
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].AddCartItem, payload: cartItem };
            this.redux.dispatch(action);
        }, err => {
            // if token expired on the server side:
            if (err.status === 401) {
    ...
    getAllCartsItemsByCartID(cartID) {
        this.httpClient.get("http://localhost:3001/api/carts-items/cartID/" + cartID, this.getHeaders())
            .subscribe(cartsItems => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].GetAllCartsItems, payload: cartsItems };
            this.redux.dispatch(action);
        }, err => {
            // if token expired on the server side:
            if (err.status === 401) {
    ...
    // Delete one cartItem:
    deleteOneCartItem(cartItemID) {
        this.httpClient.delete("http://localhost:3001/api/carts-items/" + cartItemID, this.getHeaders())
            .subscribe(() => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].DeleteOneCartItem, payload: cartItemID };
            this.redux.dispatch(action);
        }, err => {
            // if token expired on the server side:
            if (err.status === 401) {
    ...
    deleteAllCartsItems(cartID) {
        this.httpClient.delete("http://localhost:3001/api/carts-items/delete-by-cartID/" + cartID, this.getHeaders())
            .subscribe(() => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].DeleteCartsItems, payload: cartID };
            this.redux.dispatch(action);
        }, err => {
            // if token expired on the server side:
            if (err.status === 401) {
...
CartsItemsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: ng2_redux__WEBPACK_IMPORTED_MODULE_3__["NgRedux"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }
];
...
let CartsService = class CartsService {
    constructor(httpClient, redux, router, customersService) {
        this.httpClient = httpClient;
        this.redux = redux;
        this.router = router;
        this.customersService = customersService;
    ...
    logout() {
        sessionStorage.clear();
        const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_3__["ActionType"].LogOut, payload: undefined };
        this.redux.dispatch(action);
        this.router.navigate(["/home"]);
    }
    // Add new cart:
    ...
    updateCart(cart) {
        this.httpClient.patch("http://localhost:3001/api/carts/" + cart._id, cart, this.getHeaders())
            ...
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_3__["ActionType"].UpdateOneCart, payload: updatedCart };
            this.redux.dispatch(action);
        }, err => {
            // if token expired on the server side:
            if (err.status === 401) {
...
let CategoriesService = class CategoriesService {
    ...
    getAllCategories() {
        this.httpClient.get("http://localhost:3001/api/categories", this.getHeaders())
            ...
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_3__["ActionType"].GetCategories, payload: categories };
            this.redux.dispatch(action);
        }, err => {
            // if token expired on the server side:
            if (err.status === 401) {
...
let CitiesService = class CitiesService {
    ...
    getAllCities() {
        this.httpClient.get("http://localhost:3001/api/cities")
            .subscribe(cities => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_3__["ActionType"].GetCities, payload: cities };
            this.redux.dispatch(action);
        }, err => {
            alert(err.message);
        });
...
let CustomersService = class CustomersService {
    ...
    getOneCustomer(_id) {
        this.httpClient.get("http://localhost:3001/api/customers/" + _id)
            .subscribe(customer => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].GetOneCustomer, payload: customer };
            this.redux.dispatch(action);
        }, err => alert(err.message));
    }
    ...
    updateOneCustomer(customer) {
        this.httpClient.patch("http://localhost:3001/api/customers/" + customer._id, customer)
            ...
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].UpdateCustomer, payload: updatedCustomer };
            this.redux.dispatch(action);
        }, err => alert(err.message));
    }
};
...
let OrdersService = class OrdersService {
    ...
    getLastOrder(customerID) {
        this.httpClient.get("http://localhost:3001/api/orders/latest-order/" + customerID, this.getHeaders())
            .subscribe(order => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_3__["ActionType"].GetLatestOrder, payload: order };
            this.redux.dispatch(action);
        }, err => {
            // if token expired on the server side:
            if (err.status === 401) {
    ...
    getCountOrders() {
        this.httpClient.get("http://localhost:3001/api/count/count-orders")
            .subscribe(count => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_3__["ActionType"].CountAllOrders, payload: count };
            this.redux.dispatch(action);
        }, err => alert(err.message));
    }
};
...
let ProductsService = class ProductsService {
    ...
    getAllProductsByCategory(_id) {
        this.httpClient.get("http://localhost:3001/api/products/products-by-category/" + _id, this.getHeaders())
            .subscribe(products => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].GetAllProducts, payload: products };
            this.redux.dispatch(action);
        }, err => {
            // if token expired on the server side:
            if (err.status === 401) {
    ...
    getAllProductsBySearchWord(search) {
    ...
    getCountProducts() {
        this.httpClient.get("http://localhost:3001/api/count/count-products")
            .subscribe(count => {
            const action = { type: _redux_actionType__WEBPACK_IMPORTED_MODULE_4__["ActionType"].CountAllProducts, payload: count };
            this.redux.dispatch(action);
        }, err => alert(err.message));
    }
};
